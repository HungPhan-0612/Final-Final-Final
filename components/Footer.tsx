...
const Footer = () => {
    ...
    return(
      <footer className="bg-gradient-to-r from-gray-800 to-black text-white py-12">
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center mb-8 text-center md:text-left">
          ...
          <form className="mt-6 md:mt-0 flex flex-col sm:flex-row w-full sm:w-auto">
            <input
              ...
              className="px-4 py-2 w-full sm:w-64 rounded-md sm:rounded-l-md text-gray-800 focus:outline-none"
            />
            <button
              type="submit"
              className="bg-[#F5B056] text-gray-900 px-4 py-2 rounded-md sm:rounded-r-md hover:bg-yellow-500 transition mt-2 sm:mt-0 ml-1"
            >
              Subscribe
            </button>
          </form>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 text-center md:text-left mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link href="/aboutus" className="hover:text-[#F5B056] transition">Our Story</Link></li>
              <li><Link href="#" className="hover:text-[#F5B056] transition">Team</Link></li>
              <li><Link href="#" className="hover:text-[#F5B056] transition">Careers</Link></li>
              <li><Link href="#" className="hover:text-[#F5B056] transition">Press</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link href="#" className="hover:text-[#F5B056] transition">Buy Crypto</Link></li>
              <li><Link href="#" className="hover:text-[#F5B056] transition">P2P Trading</Link></li>
              <li><Link href="#" className="hover:text-[#F5B056] transition">Trade</Link></li>
              <li><Link href="#" className="hover:text-[#F5B056] transition">Convert</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link href="#" className="hover:text-[#F5B056] transition">Blog</Link></li>
              <li><Link href="#" className="hover:text-[#F5B056] transition">Help Center</Link></li>
              <li><Link href="#" className="hover:text-[#F5B056] transition">API Docs</Link></li>
              <li><Link href="#" className="hover:text-[#F5B056] transition">Support</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link href="#" className="hover:text-[#F5B056] transition">Privacy Policy</Link></li>
              <li><Link href="#" className="hover:text-[#F5B056] transition">Terms of Service</Link></li>
              <li><Link href="#" className="hover:text-[#F5B056] transition">Cookie Policy</Link></li>
            </ul>
          </div>
        </div>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center border-t border-gray-700 pt-6 text-center">
          ...
          <div className="flex space-x-6">
            <Link href="https://facebook.com" className="hover:text-[#F5B056] transition">
            ...
            <Link href="https://twitter.com" className="hover:text-[#F5B056] transition">
              <svg className="w-6 h-6 fill-current" viewBox="0 0 24 24">
            ...
            <Link href="https://instagram.com" className="hover:text-[#F5B056] transition">
              <svg className="w-6 h-6 fill-current" viewBox="0 0 24 24">
