  ...
  return (
    <header className="flex items-center bg-black h-16 px-4">
      ...
      <nav className="hidden md:flex justify-center items-center space-x-6">
        <Link href="/" className="text-white text-xs uppercase hover:text-[#F5B056] transition">
          Home
        </Link>
        <Link href="/transactions" className="text-white text-xs uppercase hover:text-[#F5B056] transition">
          Transactions
        </Link>
        <a href="mailto:cryptopath@gmail.com" className="text-white text-xs uppercase hover:text-[#F5B056] transition">
          Support
        </a>
        ...
        {currentUser ? 
              ...
              (
                <Link href="/login" className="text-white text-xs uppercase hover:text-[#F5B056] transition">
                  Login
                </Link>
              )
            }
      ...
      {isOpen && (
        <div className="absolute top-16 right-0 w-64 bg-black text-white p-6 shadow-lg md:hidden z-50 w-screen">
          <nav className="flex flex-col space-y-4 text-center text-xl">
            <Link href="/" className="text-xs uppercase hover:text-[#F5B056] transition" onClick={() => setIsOpen(false)}>
              Home
            </Link>
            <Link href="/transactions" className="text-xs uppercase hover:text-[#F5B056] transition" onClick={() => setIsOpen(false)}>
              Transactions
            </Link>
            <a href="mailto:cryptopath@gmail.com" className="text-xs uppercase hover:text-[#F5B056] transition" onClick={() => setIsOpen(false)}>
              Support
            </a>
